...
public class CreateItemTest{
    ...
    // String series = RandomString.getAlphaNumericString(alpha, 10);
    @Test
    public void Test01() throws IOException{
        ...
        CreateAuction createAuction = new CreateAuction(6,"2023/07/14 11:31","2024/07/21 11:31",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
        CreateItem createItem = new CreateItem(createAuction.getAuctionId(),"girl",300, 1, "beautiful",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
    ...
    public void Test02() throws IOException{
        ...
        LoginRequest login = new LoginRequest("giang.dq204542@sis.hust.edu.vn","giangcvp");
        CreateAuction createAuction = new CreateAuction(5,"2023/07/14 11:31","2024/07/21 11:31",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
        CreateItem createItem = new CreateItem(createAuction.getAuctionId(),"ire",6300, 20, "lonia",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
        int code = createItem.getCode();
    ...
    public void Test03() throws IOException{
        ...
        try{
            LoginRequest login = new LoginRequest("giang.dq204542@sis.hust.edu.vn","giangcvp");
            CreateItem createItem = new CreateItem("3000000000","ire",6300, 3, "lonia",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
            int code = createItem.getCode();
    ...
    public void Test04() throws IOException{
        ...
        LoginRequest login = new LoginRequest("giang.dq204542@sis.hust.edu.vn","giangcvp");
        CreateItem createItem = new CreateItem("929","ire",6300, 20, "lonia",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
        int code = createItem.getCode();
    ...
    public void Test06() throws IOException{
        ...
        LoginRequest login = new LoginRequest("giang.dq204542@sis.hust.edu.vn","giangcvp");
        CreateAuction createAuction = new CreateAuction(5,"2023/07/14 11:31","2024/07/21 11:31",RandomString.getAlphaNumericString(alpha, 10), login.getAccess_token());
        CreateItem createItem = new CreateItem(createAuction.getAuctionId(),"girl",300, 1, "beautiful",RandomString.getAlphaNumericString(alpha, 11), login.getAccess_token());
        int code = createItem.getCode();
        Assert.assertEquals(1001,code);
